...
export const dashboardContent = {
  ...
  clients: {
    ...
    perIp: "ดาวน์โหลดต่อ IP",
    browser: "เบราว์เซอร์",
    os: "ระบบปฏิบัติการ",
    device: "อุปกรณ์",
    topIps: "IP ที่ดาวน์โหลดมากที่สุด",
    topN: 6,
    unknownLabel: "ไม่ทราบ",
    showAllLabel: "แสดงทั้งหมด",
    showLessLabel: "แสดงน้อยลง",
    // Keys match DeviceKind from @/lib/downloads/user-agent.
    deviceLabels: {
      desktop: "เดสก์ท็อป",
      mobile: "มือถือ",
      tablet: "แท็บเล็ต",
  ...
  log: {
    title: "บันทึกการดาวน์โหลด",
    caption: "ล่าสุด 200 รายการ · เวลาเป็นเขตเอเชีย/กรุงเทพฯ",
