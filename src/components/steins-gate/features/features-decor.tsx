...
export function FeaturesDecor() {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
      ...
      <Gear
        teeth={22}
        className="text-secondary/40 absolute top-[2%] right-[6%] size-44 md:size-64 lg:size-88"
        spin="forward"
        durationSec={150}
      />
      <Gear
        teeth={16}
        className="text-secondary/35 absolute top-[42%] left-[4%] size-36 md:size-52 lg:size-72"
        spin="reverse"
        durationSec={104}
      />
      <Gear
        teeth={26}
        className="text-secondary/45 absolute bottom-[6%] left-[36%] size-48 md:size-72 lg:size-96"
        spin="forward"
        durationSec={170}
      />
